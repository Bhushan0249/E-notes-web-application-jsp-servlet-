...
<body>
	...
	<!-- Main -->
	<div class="main">
		<h2>Welcome To My E-Notes Web Application </h2>
		<div class="card">
			<div class="card-body">
				...
				<table>
					<tbody>
						<tr>
							...
							<td>:</td>
							<td>Bhushan Galphade</td>
						</tr>
						
						<tr>
							<td>About Developer :</td>
							<td>:</td>
							<td>Hi there! I’m Bhushan, a passionate and eager-to-learn
								fresh graduate in Computer Science. I’ve doned my skills in web
								development and programming through my studies and personal
								projects. I’m excited to dive into real-world coding challenges
								and contribute to open-source projects. Let’s connect and
								collaborate!</td>
						</tr>
						<br>
						<tr>
							<td>About Project :</td>
							<td>:</td>
							<td>E-Notes Web Application Developed a note-taking
								application using Eclipse IDE with a front-end built in HTML,
								CSS, Bootstrap 4, and Font Awesome. Implemented back-end
								functionality using JSP, Servlets, and JDBC with a MySQL
								database. Features include user registration, login/logout, and
								the ability to add, edit, delete, and display notes.</td>
						</tr>
